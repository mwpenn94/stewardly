  ...
  return (
    <>
      <button type="button"
        ...
        className="inline-flex items-center gap-1.5 rounded-md border border-border/60 px-2.5 py-1 text-xs hover:border-primary/40 hover:text-primary transition-colors"
