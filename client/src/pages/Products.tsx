    ...
    <div className="min-h-screen animate-curtain-lift">
      ...
      <div className="border-b border-border/50 bg-card/30 backdrop-blur-sm sticky top-0 z-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center gap-3">
          ...
          {isAdmin && (
            <Button size="sm" className="bg-accent text-accent-foreground hover:bg-primary/90 text-xs gap-1.5 h-8" onClick={() => setShowCreateDialog(true)}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {companyProducts.map(product => {
                    ...
                    return (
                      <Card
                        key={product.id}
                        className={`bg-card/60 border-border/50 hover:border-primary/20 transition-all cursor-pointer ${isExpanded ? "ring-1 ring-accent/20" : ""}`}
                      ...
                      >
                        <CardContent className="p-4 space-y-2.5">
                          <div className="flex items-start justify-between gap-2">
                            ...
                            {product.isPlatform && (
                              <Badge variant="outline" className="text-[8px] shrink-0 border-primary/20 text-primary">Platform</Badge>
                            )}
                          </div>
      ...
      <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button
              size="sm"
              className="bg-accent text-accent-foreground hover:bg-primary/90 text-xs gap-1.5"
