        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row items-center gap-5">
            ...
            <div className="space-y-2 flex-1">
              ...
              <Button
                size="sm"
                className="bg-accent text-accent-foreground hover:bg-primary/90"
      ...
      <Card className="bg-card/50 border-border/50">
        ...
        <CardContent className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              size="sm"
              className="bg-accent text-accent-foreground hover:bg-primary/90 text-xs"
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex gap-1.5 flex-1 min-w-[200px]">
              ...
              />
              <Button
                size="sm" className="h-8 bg-accent text-accent-foreground hover:bg-primary/90 text-xs px-2.5"
