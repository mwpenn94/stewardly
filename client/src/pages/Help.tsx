        ...
        <Tabs defaultValue="guide" className="w-full">
          ...
          <TabsContent value="contact" className="mt-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <Card className="hover:border-primary/30 transition-colors cursor-pointer" role="button" tabIndex={0} onClick={() => navigate("/chat")} onKeyDown={(e: React.KeyboardEvent) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); (() => navigate("/chat"))(); } }}>
              ...
              <Card className="hover:border-primary/30 transition-colors cursor-pointer" role="button" tabIndex={0} onClick={() => navigate("/settings/guest-prefs")} onKeyDown={(e: React.KeyboardEvent) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); (() => navigate("/settings/guest-prefs"))(); } }}>
                <CardContent className="p-4 flex items-center gap-3">
              ...
              <Card className="hover:border-primary/30 transition-colors cursor-pointer" role="button" tabIndex={0} onClick={() => navigate("/settings/ai-tuning")} onKeyDown={(e: React.KeyboardEvent) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); (() => navigate("/settings/ai-tuning"))(); } }}>
                <CardContent className="p-4 flex items-center gap-3">
