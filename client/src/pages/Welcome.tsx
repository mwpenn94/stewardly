      ...
      <header className="relative z-10 border-b border-border/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              <Button size="sm" onClick={() => navigate("/chat")} className="bg-accent hover:bg-primary/90 text-accent-foreground border-0 shadow-[0_4px_16px_-6px] shadow-accent/50">
                Go to Chat
              </Button>
            ) : (
              <>
                ...
                <Button size="sm" onClick={() => navigate("/signin")} className="bg-accent hover:bg-primary/90 text-accent-foreground border-0 shadow-[0_4px_16px_-6px] shadow-accent/50">
                  Sign In
                </Button>
              </>
            )}
          ...
          <div className="text-center space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button
                ...
                className="bg-accent hover:bg-primary/90 text-accent-foreground border-0 px-8 text-base font-semibold shadow-[0_8px_32px_-8px] shadow-accent/50"
              >
