              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-2">
                  {decadeAverages.map((d) => (
                    <button type="button"
                      key={d.decade}
                      className={`p-2 rounded-md border text-left transition-all hover:border-primary/50 ${decadeFilter === d.decade.replace("s", "") + "s" ? "border-accent bg-primary/5" : "bg-secondary/50"}`}
