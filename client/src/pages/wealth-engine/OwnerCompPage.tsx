        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <Badge variant="outline" className="h-4 text-[9px] border-primary/40 text-primary px-1">
                New
              </Badge>
            </div>
                  ...
                  >
                    <CardHeader className="pb-2">
                      <div className="flex items-center justify-between">
                        ...
                        {isBest && (
                          <Badge variant="outline" className="h-4 text-[9px] border-primary/50 text-primary px-1">
                            Best
                          </Badge>
                        )}
                      </div>
