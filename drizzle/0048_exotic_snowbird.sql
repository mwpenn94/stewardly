...
CREATE INDEX `idx_coi_verification_badges_coi_contact_id` ON `coi_verification_badges` (`coi_contact_id`);--> statement-breakpoint
CREATE INDEX `idx_coi_verification_badges_professional_id` ON `coi_verification_badges` (`professional_id`);--> statement-breakpoint
CREATE INDEX `idx_coi_verification_badges_source_verification_id` ON `coi_verification_badges` (`source_verification_id`);--> statement-breakpoint
...
CREATE INDEX `idx_enrichment_cache_connection_id` ON `enrichment_cache` (`connection_id`);--> statement-breakpoint
...
CREATE INDEX `idx_integration_connections_provider_id` ON `integration_connections` (`provider_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_connections_owner_id` ON `integration_connections` (`owner_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_connections_organization_id` ON `integration_connections` (`organization_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_connections_user_id` ON `integration_connections` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_field_mappings_connection_id` ON `integration_field_mappings` (`connection_id`);--> statement-breakpoint
...
CREATE INDEX `idx_integration_sync_logs_connection_id` ON `integration_sync_logs` (`connection_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_sync_logs_triggered_by_user_id` ON `integration_sync_logs` (`triggered_by_user_id`);--> statement-breakpoint
CREATE INDEX `idx_integration_webhook_events_connection_id` ON `integration_webhook_events` (`connection_id`);--> statement-breakpoint
...
CREATE INDEX `idx_manager_ai_settings_manager_id` ON `manager_ai_settings` (`managerId`);--> statement-breakpoint
CREATE INDEX `idx_manager_ai_settings_organization_id` ON `manager_ai_settings` (`organizationId`);--> statement-breakpoint
...
CREATE INDEX `idx_organization_ai_settings_organization_id` ON `organization_ai_settings` (`organizationId`);--> statement-breakpoint
...
CREATE INDEX `idx_plaid_items_user_id` ON `plaid_items` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_plaid_items_item_id` ON `plaid_items` (`item_id`);--> statement-breakpoint
...
CREATE INDEX `idx_professional_ai_settings_professional_id` ON `professional_ai_settings` (`professionalId`);--> statement-breakpoint
CREATE INDEX `idx_professional_ai_settings_organization_id` ON `professional_ai_settings` (`organizationId`);--> statement-breakpoint
CREATE INDEX `idx_professional_ai_settings_manager_id` ON `professional_ai_settings` (`managerId`);--> statement-breakpoint
...
CREATE INDEX `idx_professional_verifications_professional_id` ON `professional_verifications` (`professional_id`);--> statement-breakpoint
CREATE INDEX `idx_professional_verifications_external_id` ON `professional_verifications` (`external_id`);--> statement-breakpoint
...
CREATE INDEX `idx_snaptrade_accounts_user_id` ON `snaptrade_accounts` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_accounts_connection_id` ON `snaptrade_accounts` (`connection_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_accounts_snap_trade_account_id` ON `snaptrade_accounts` (`snaptrade_account_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_brokerage_connections_user_id` ON `snaptrade_brokerage_connections` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_brokerage_connections_snap_trade_user_id` ON `snaptrade_brokerage_connections` (`snaptrade_user_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_brokerage_connections_brokerage_authorization_id` ON `snaptrade_brokerage_connections` (`brokerage_authorization_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_positions_user_id` ON `snaptrade_positions` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_positions_account_id` ON `snaptrade_positions` (`account_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_users_user_id` ON `snaptrade_users` (`user_id`);--> statement-breakpoint
CREATE INDEX `idx_snaptrade_users_snap_trade_user_id` ON `snaptrade_users` (`snaptrade_user_id`);--> statement-breakpoint
...
CREATE INDEX `idx_user_organization_roles_user_id` ON `user_organization_roles` (`userId`);--> statement-breakpoint
CREATE INDEX `idx_user_organization_roles_organization_id` ON `user_organization_roles` (`organizationId`);--> statement-breakpoint
CREATE INDEX `idx_user_organization_roles_manager_id` ON `user_organization_roles` (`managerId`);--> statement-breakpoint
CREATE INDEX `idx_user_organization_roles_professional_id` ON `user_organization_roles` (`professionalId`);--> statement-breakpoint
...
CREATE INDEX `idx_verification_schedules_professional_id` ON `verification_schedules` (`professional_id`);--> statement-breakpoint
...
DROP PROCEDURE IF EXISTS sw_add_column_if_missing;
--> statement-breakpoint
...
END;
--> statement-breakpoint
-- users: 32 new column(s)
CALL sw_add_column_if_missing('users', 'authTier', '`authTier` enum("anonymous", "email", "full", "advisor_connected") NOT NULL DEFAULT "full"');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'affiliateOrgId', '`affiliateOrgId` int');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'anonymousConversationCount', '`anonymousConversationCount` int NOT NULL DEFAULT 0');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'passwordHash', '`passwordHash` text');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'styleProfile', '`styleProfile` text');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'suitabilityCompleted', '`suitabilityCompleted` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'suitabilityData', '`suitabilityData` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'settings', '`settings` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'avatarUrl', '`avatarUrl` text');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'tosAcceptedAt', '`tosAcceptedAt` timestamp NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'auth_provider', '`auth_provider` varchar(20) DEFAULT "manus"');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'linkedin_id', '`linkedin_id` varchar(100)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_id', '`google_id` varchar(100)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'linkedin_profile_url', '`linkedin_profile_url` varchar(500)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'linkedin_headline', '`linkedin_headline` varchar(300)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'linkedin_industry', '`linkedin_industry` varchar(100)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'linkedin_location', '`linkedin_location` varchar(200)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_phone', '`google_phone` varchar(50)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_birthday', '`google_birthday` timestamp NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_gender', '`google_gender` varchar(20)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_address_json', '`google_address_json` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'google_organizations_json', '`google_organizations_json` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'employer_name', '`employer_name` varchar(200)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'job_title', '`job_title` varchar(200)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'profile_enriched_at', '`profile_enriched_at` timestamp NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'profile_enrichment_source', '`profile_enrichment_source` varchar(50)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'sign_in_data_json', '`sign_in_data_json` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'stripe_customer_id', '`stripe_customer_id` varchar(255)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'stripe_subscription_id', '`stripe_subscription_id` varchar(255)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'stripe_plan_id', '`stripe_plan_id` varchar(255)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'stripe_subscription_status', '`stripe_subscription_status` varchar(50)');
--> statement-breakpoint
CALL sw_add_column_if_missing('users', 'stripe_current_period_end', '`stripe_current_period_end` timestamp NULL');
--> statement-breakpoint

-- tasks: 13 new column(s)
CALL sw_add_column_if_missing('tasks', 'user_id', '`user_id` int NOT NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'assigned_to', '`assigned_to` int');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'client_id', '`client_id` int');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'description', '`description` text');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'category', '`category` enum("client_review", "compliance", "onboarding", "follow_up", "planning", "admin", "meeting_prep", "document", "other") DEFAULT "other"');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'due_date', '`due_date` timestamp NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'completed_at', '`completed_at` timestamp NULL');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'recurring', '`recurring` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'recurring_interval', '`recurring_interval` enum("daily", "weekly", "monthly", "quarterly", "annually")');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'related_entity_type', '`related_entity_type` varchar(64)');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'related_entity_id', '`related_entity_id` int');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'created_at', '`created_at` timestamp NULL DEFAULT (now())');
--> statement-breakpoint
CALL sw_add_column_if_missing('tasks', 'updated_at', '`updated_at` timestamp NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP');
--> statement-breakpoint

-- user_preferences: 34 new column(s)
CALL sw_add_column_if_missing('user_preferences', 'communicationStyle', '`communicationStyle` enum("simple", "detailed", "expert") DEFAULT "detailed"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'responseLength', '`responseLength` enum("concise", "standard", "comprehensive") DEFAULT "standard"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'responseFormat', '`responseFormat` varchar(64) DEFAULT "mixed"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'ttsVoice', '`ttsVoice` varchar(64) DEFAULT "en-US-JennyNeural"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'autoPlayVoice', '`autoPlayVoice` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'handsFreeMode', '`handsFreeMode` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'autoGenerateCharts', '`autoGenerateCharts` boolean DEFAULT true');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'riskTolerance', '`riskTolerance` enum("conservative", "moderate", "aggressive")');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'financialGoals', '`financialGoals` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'taxFilingStatus', '`taxFilingStatus` varchar(64)');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'stateOfResidence', '`stateOfResidence` varchar(64)');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'theme', '`theme` enum("system", "light", "dark") DEFAULT "dark"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'sidebarDefault', '`sidebarDefault` enum("expanded", "collapsed") DEFAULT "expanded"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'chatDensity', '`chatDensity` enum("comfortable", "compact") DEFAULT "comfortable"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'language', '`language` varchar(64) DEFAULT "en"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'modelPreferences', '`modelPreferences` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'ensembleWeights', '`ensembleWeights` json');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'temperature', '`temperature` float');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'maxTokens', '`maxTokens` int');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'customPromptAdditions', '`customPromptAdditions` text');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'focusModeDefaults', '`focusModeDefaults` varchar(128) DEFAULT "general,financial"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'thinkingDepth', '`thinkingDepth` enum("quick", "standard", "deep", "extended") DEFAULT "standard"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'creativity', '`creativity` float DEFAULT 0.7');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'contextDepth', '`contextDepth` enum("recent", "moderate", "full") DEFAULT "moderate"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'disclaimerVerbosity', '`disclaimerVerbosity` enum("minimal", "standard", "comprehensive") DEFAULT "standard"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'autoFollowUp', '`autoFollowUp` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'autoFollowUpCount', '`autoFollowUpCount` int DEFAULT 1');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'discoveryDirection', '`discoveryDirection` enum("deeper", "broader", "applied", "auto") DEFAULT "auto"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'discoveryIdleThresholdMs', '`discoveryIdleThresholdMs` int DEFAULT 120000');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'discoveryContinuous', '`discoveryContinuous` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'crossModelVerify', '`crossModelVerify` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'citationStyle', '`citationStyle` enum("none", "inline", "footnotes") DEFAULT "none"');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'reasoningTransparency', '`reasoningTransparency` boolean DEFAULT false');
--> statement-breakpoint
CALL sw_add_column_if_missing('user_preferences', 'customShortcuts', '`customShortcuts` json');
--> statement-breakpoint
